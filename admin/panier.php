...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <?php if (empty($produits_panier)): ?>
            <div class="alert alert-info">Votre panier est vide. <a href="../client/catalogue.php">Retourner au catalogue</a></div>
        <?php else: ?>
            <table class="table align-middle bg-white rounded shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?php $image_src = !empty($prod['image_url']) ? '../' . ltrim($prod['image_url'], '/') : '../IMAGE/organic section.png'; ?>
                            <img src="<?php echo htmlspecialchars($image_src); ?>" style="width: 50px; height: 50px; object-fit: cover;" class="rounded me-2">
            ...
            <div class="text-end mt-4">
                ...
                <a href="../client/catalogue.php" class="btn btn-outline-secondary">Continuer mes achats</a>
                <form action="valider_commande.php" method="POST" style="display: inline-block;">
                    <button type="submit" class="btn btn-success px-4">Valider la commande</button>
                </form>
            </div>
        <?php endif; ?>
    </div>
